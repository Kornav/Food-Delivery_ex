...
public class Order  {
    ...
    public static void updateOrderStatus(CookingStart cookingStart){
        ...
        */
        ...
        repository().findById(cookingStart.get???()).ifPresent(order->{
    ...
    public static void updateOrderStatus(CookingCompleted cookingCompleted){
        ...
        */
        ...
        repository().findById(cookingCompleted.get???()).ifPresent(order->{
